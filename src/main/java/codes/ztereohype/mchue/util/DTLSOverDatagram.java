...
//            log("Client", "=======handshake(" + loops + ", " + hs + ")=======");
//            if (hs == SSLEngineResult.HandshakeStatus.NEED_UNWRAP ||
//                    hs == SSLEngineResult.HandshakeStatus.NEED_UNWRAP_AGAIN) {
//
//                log("Client", "Receive DTLS records, handshake status is " + hs);
//
//                ByteBuffer iNet;
//                ByteBuffer iApp;
//                if (hs == SSLEngineResult.HandshakeStatus.NEED_UNWRAP) {
...
//                        log("Client", "Warning: " + ste);
//
//                        List<DatagramPacket> packets = new ArrayList<>();
//                        boolean finished = onReceiveTimeout(
//                                engine, peerAddr, "Client", packets);
//
//                        log("Client", "Reproduced " + packets.size() + " packets");
...
//
//                        if (finished) {
//                            log("Client", "Handshake status is FINISHED "
//                                    + "after calling onReceiveTimeout(), "
//                                    + "finish the loop");
//                            endLoops = true;
//                        }
//
//                        log("Client", "New handshake status is "
...
//                    log("Client", "BUFFER_OVERFLOW, handshake status is " + hs);
//
//                    // the client maximum fragment size config does not work?
//                    throw new Exception("Buffer overflow: " +
//                            "incorrect client maximum fragment size");
//                } else if (rs == SSLEngineResult.Status.BUFFER_UNDERFLOW) {
//                    log("Client", "BUFFER_UNDERFLOW, handshake status is " + hs);
//
...
//                    log("Client", "Handshake status is FINISHED, finish the loop");
//                    endLoops = true;
//                }
...
//                        engine, peerAddr, "Client", packets);
//
//                log("Client", "Produced " + packets.size() + " packets");
//                for (DatagramPacket p : packets) {
//                    socket.send(p);
//                }
//
...
//
//        SSLEngineResult.HandshakeStatus hs = engine.getHandshakeStatus();
//        log("Client", "Handshake finished, status is " + hs);
//
...
//        }
//        log("Client", "Negotiated protocol is " + session.getProtocol());
//        log("Client", "Negotiated cipher suite is " + session.getCipherSuite());
//
